...
import { SignosConsultaComponent } from './signos/signos-consulta/signos-consulta.component';
import { DialogosignosComponent} from './signos/signos-consulta/dialogosignos/dialogosignos.component';
...
@NgModule({
    ...
    declarations: [
        ...
        SignosComponent,
        SignosConsultaComponent,
        DialogosignosComponent               
    ],
    providers: [],
})
